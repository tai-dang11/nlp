...
def squad_datasets(qa_datasets):
    tokenized_datasets = qa_datasets.map(prepare_train_features, batched=True,
                                      remove_columns=qa_datasets["train"].column_names)
    ...
    return tf_train_set,tf_validation_set,tokenized_datasets